<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MultiselectDropdownIntroducer.ascx.cs"
    Inherits="WebControl_MultiselectDropdownIntroducer" %>
...
<asp:UpdatePanel ID="updatepanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:TextBox ID="TextBox1" runat="server" ReadOnly="true" Text='<%# setValue() %>' CssClass="multiDropdownlistWidth"></asp:TextBox>
