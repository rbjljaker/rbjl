<%@ Page Title="" Language="C#" MasterPageFile="~/MasterReport.master" AutoEventWireup="true"
    CodeFile="DebitNoteReportNewView.aspx.cs" Inherits="Report_DebitNoteReportNewView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainContent" runat="Server">
  <%--  <rsweb:ReportViewer ID="ReportViewerDebitNote" runat="server" Font-Names="Verdana"
        ...
        <LocalReport ReportPath="ReportFrame\DebitNoteReportHr.rdlc" EnableExternalImages="True">
        </LocalReport>
    </rsweb:ReportViewer>--%>
</asp:Content>
