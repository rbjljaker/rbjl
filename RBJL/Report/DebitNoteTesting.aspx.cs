...
public partial class Report_DebitNoteTesting : System.Web.UI.Page
{
    ...
    private List<string> getDebitNoteHr(DateTime createTIme, string debitNoteNum, string category)
    {
        ...
        if (getType != null)
        {
            ...
            foreach (var item in tempArr)
            {
                ...
                else if (item.Equals("Notany Public"))
                {
                    result.Add(String.Format("{0}{1}/{2}", tarString, tarYear, debitNoteNum));
                }
            }
    ...
    {
        if (e.ReportPath == "DebitNoteSubReportTesting1")
        {
