...
public partial class Master_Keyword : CultureEnabledPage
{
    ...
    {
        EntityDataSourceKeyword.ContextType = typeof(RBJLLawFirmDBModel.RBJLLawFirmDBEntities);
    }
