...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMainContent" runat="Server">
    <div class="Tab">
        <ajaxToolkit:TabContainer ID="TabContainerDebitNoteCore" runat="server" ActiveTabIndex="0">
                            ...
                            <ContentTemplate>
                                <table class="lineHeight">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CheckBox ID="customSortingCheckBox" runat="server" Text="" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
            ...
            <ajaxToolkit:TabPanel ID="TabPanelMis" runat="server" HeaderText="Miscellaneous charges">
                <ContentTemplate>
                    <asp:Panel ID="PanelMis" runat="server">
                        <uc1:WebUserControlCostOrDisbursement ID="wcMis" runat="server" type="Misc" />
                    </asp:Panel>
                </ContentTemplate>
            </ajaxToolkit:TabPanel>
    ...
    <asp:Button ID="ButtonCostNext" runat="server" Text="Next" OnClick="ButtonCostNext_Click"
        Visible="false" />
    <asp:Button ID="ButtonMiscNext" runat="server" Text="Next" OnClick="ButtonMiscNext_Click"
        Visible="false" />
