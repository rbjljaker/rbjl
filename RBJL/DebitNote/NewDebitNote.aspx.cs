...
public partial class DebitNote_NewDebitNote : CultureEnabledPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (getDebitNoteId != null)
            {
                ...
                if (debitNoteInfo.customSortingCheckBox.HasValue)
                {
                    customSortingCheckBox.Checked = debitNoteInfo.customSortingCheckBox.Value;
                }

                if (debitNoteInfo.mustShowHeader.HasValue)
                {
                    mustShowHeader.Checked = debitNoteInfo.mustShowHeader.Value;
                }
    ...
    private void initValue()
    {
        ...
        SessionClass.DebitNoteMiscDataTable = null;
    ...
    private DebitNoteDto getDebitNoteCoreDto()
    {
        ...
        dND.mustShowHeader=mustShowHeader.Checked;
        ...
        dND.customSortingCheckBox = customSortingCheckBox.Checked;
    ...
    protected void ButtonMiscNext_Click(object sender, EventArgs e)
    {
        initTab(4);
    }
    ...
    {
        Button[] btnArr = new Button[5] { ButtonGeneralSubmit, ButtonCostNext, ButtonMiscNext, ButtonDisbursementNext, ButtonNarrativeNext };
        for (int i = 0; i < 5; i++)
        {
            if (i == indexBtn)
            {
